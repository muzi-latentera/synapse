            ...
            <div className="mt-0.5 overflow-hidden rounded-md border border-border/50 dark:border-border-dark/50">
              {branchesLoading ? (
                <div className="flex items-center justify-center gap-1.5 px-2 py-3">
                  <Loader2 className="h-3 w-3 animate-spin motion-reduce:animate-none text-text-quaternary dark:text-text-dark-quaternary" />
                  <span className="text-2xs text-text-quaternary dark:text-text-dark-quaternary">
                    Loading branches…
                  </span>
                </div>
    ...
    <div className="flex flex-col gap-2">
      {SKELETON_ITEMS.map((i) => (
        <div key={i} className="flex items-start gap-2.5 px-2.5 py-2">
          <div className="mt-0.5 h-3.5 w-3.5 shrink-0 animate-pulse motion-reduce:animate-none rounded bg-surface-tertiary dark:bg-surface-dark-tertiary" />
          <div className="flex-1 space-y-1.5">
            <div className="h-3 w-2/3 animate-pulse motion-reduce:animate-none rounded bg-surface-tertiary dark:bg-surface-dark-tertiary" />
            <div className="h-2.5 w-full animate-pulse motion-reduce:animate-none rounded bg-surface-tertiary dark:bg-surface-dark-tertiary" />
          </div>
        </div>
      ))}
    </div>
                    ...
                    <div className="max-h-[12rem] overflow-y-auto">
                      {createWorkspace.isPending ? (
                        <div className="flex items-center justify-center gap-2 px-2.5 py-6">
                          <Loader2 className="h-3.5 w-3.5 animate-spin motion-reduce:animate-none text-text-quaternary dark:text-text-dark-quaternary" />
